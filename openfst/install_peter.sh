...
./configure --prefix=${OPT_DIR}/${VERSION}${TOOLCHAIN} --enable-python --enable-static --enable-shared --enable-far --enable-ngram-fsts --enable-lookahead-fsts --enable-const-fsts --enable-pdt --enable-linear-fsts LIBS="-ldl" 
...
prepend-path PYTHONPATH ${OPT_DIR}/${VERSION}${TOOLCHAIN}/lib/python2.7/site-packages
