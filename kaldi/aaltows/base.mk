...
KALDILIBDIR := /teamwork/t40511_asr/Modules/opt/kaldi/kaldi-${KALDI_COMMIT}/src/lib
CONFIGURE_VERSION := 2
FSTROOT = /m/teamwork/t40511_asr/Modules/opt/openfst/openfst-1.4.1
OPENFST_VER = 1.4.1
OPENFST_GE_10400 = 1
EXTRA_CXXFLAGS += -DHAVE_OPENFST_GE_10400 -std=c++0x
OPENFSTLIBS = -L/m/teamwork/t40511_asr/Modules/opt/openfst/openfst-1.4.1/lib -lfst
OPENFSTLDFLAGS = -Wl,-rpath=/m/teamwork/t40511_asr/Modules/opt/openfst/openfst-1.4.1/lib
